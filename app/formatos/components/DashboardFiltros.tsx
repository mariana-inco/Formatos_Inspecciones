      ...
      <div className="grid min-w-0 gap-3 md:grid-cols-2 xl:grid-cols-[minmax(220px,1.4fr)_minmax(160px,0.8fr)_minmax(190px,1fr)_minmax(190px,1fr)_auto]">
        ...
        <label className="grid min-w-0 gap-1">
          ...
          <select
            ...
            className="min-w-0 rounded-full border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 outline-none focus:border-[#006948]"
          >
        ...
        <label className="grid min-w-0 gap-1">
          ...
          <select value={formato} onChange={(event) => actualizarFiltro("formato", event.target.value)} className="min-w-0 rounded-full border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 outline-none focus:border-[#006948]">
        ...
        <label className="grid min-w-0 gap-1">
          ...
          <select value={estado} onChange={(event) => actualizarFiltro("estado", event.target.value)} className="min-w-0 rounded-full border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 outline-none focus:border-[#006948]">
